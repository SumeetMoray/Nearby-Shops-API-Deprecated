...
public class ItemResource {
	...
	public Response getItems(
			...
			@QueryParam("latmin")int latmin,
			@QueryParam("latmax")int latmax,
			@QueryParam("lonmin")int lonmin,
			@QueryParam("lonmax")int lonmax,
			@QueryParam("radiusOfService")int radiusOfService)
	
	{
		...
		List<Item> list = 
				Globals.itemService.getItems(itemCategoryID,shopID);
