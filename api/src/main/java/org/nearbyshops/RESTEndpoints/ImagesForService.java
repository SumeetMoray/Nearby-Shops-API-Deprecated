...
public class ImagesForService {
     ...
     */
    private static final java.nio.file.Path BASE_DIR_SERVICE_CONFIG = Paths.get("./service_images");
    ...
    public List<Image> getFileNames() throws IOException {
        ...
        */
        ...
        for (java.nio.file.Path entry : Files.newDirectoryStream(BASE_DIR_SERVICE_CONFIG)) {
    ...
    public Response uploadImage(InputStream in, @HeaderParam("Content-Length") long fileSize) throws IOException {
        ...
        File theDir = new File("./service_images");

        // if the directory does not exist, create it
        if (!theDir.exists()) {

            System.out.println("creating directory: " + "./service_images");
        ...
        */
        ...
        Files.copy(in, BASE_DIR_SERVICE_CONFIG.resolve(fileName), StandardCopyOption.REPLACE_EXISTING);
    ...
    public InputStream getJpegImage(@PathParam("name") String fileName) throws IOException {
        ...
        //fileName += ".jpg";
        java.nio.file.Path dest = BASE_DIR_SERVICE_CONFIG.resolve(fileName);
    ...
    public Response deleteImageFile(@PathParam("name")String fileName)
    {
    	...
    	try {
    		...
    		deleteStatus = Files.deleteIfExists(BASE_DIR_SERVICE_CONFIG.resolve(fileName));
